...
import * as import11 from '../../app/modal/modal.component';
import * as import12 from './modal/modal.component.ngfactory';
...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  ...
  _ModalComponent_2_4:import11.ModalComponent;
  _text_3:any;
  _text_4:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_2 = this.renderer.createElement(this._el_0,'app-modal',(null as any));
    this._appEl_2 = new import2.AppElement(2,0,this,this._el_2);
    var compView_2:any = import12.viewFactory_ModalComponent0(this.viewUtils,this.injector(2),this._appEl_2);
    this._ModalComponent_2_4 = new import11.ModalComponent();
    this._appEl_2.initComponent(this._ModalComponent_2_4,[],compView_2);
    compView_2.create(this._ModalComponent_2_4,[],(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import11.ModalComponent) && (2 === requestNodeIndex))) { return this._ModalComponent_2_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._ModalComponent_2_4.ngOnInit(); }
...
export function viewFactory_AppComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('/Users/raincal/ng2-daily-ui/001-sign-up/src/app/app.component.html',0,import8.ViewEncapsulation.Emulated,styles_AppComponent,{})); }
