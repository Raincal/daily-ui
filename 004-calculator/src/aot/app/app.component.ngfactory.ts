...
import * as import11 from '../../app/calculator/calculator.component';
import * as import12 from './calculator/calculator.component.ngfactory';
...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _CalculatorComponent_0_4:import11.CalculatorComponent;
  _text_1:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_0 = this.renderer.createElement(parentRenderNode,'app-calculator',(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = import12.viewFactory_CalculatorComponent0(this.viewUtils,this.injector(0),this._appEl_0);
    this._CalculatorComponent_0_4 = new import11.CalculatorComponent();
    this._appEl_0.initComponent(this._CalculatorComponent_0_4,[],compView_0);
    compView_0.create(this._CalculatorComponent_0_4,[],(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import11.CalculatorComponent) && (0 === requestNodeIndex))) { return this._CalculatorComponent_0_4; }
    return notFoundResult;
  }
...
export function viewFactory_AppComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('/Users/raincal/ng2-daily-ui/004-calculator/src/app/app.component.html',0,import8.ViewEncapsulation.Emulated,styles_AppComponent,{})); }
